...
-(void) preload {
    ...
    // Preload sounds
	[soundEngine_ preloadEffect:@"Stumble.wav"];
	[soundEngine_ preloadEffect:@"Powerup.wav"];
	[soundEngine_ preloadEffect:@"Pickup_Coin.wav"];
	[soundEngine_ preloadEffect:@"Jump.wav"];
    [soundEngine_ preloadEffect:@"CoinFairy.wav"];
    [soundEngine_ preloadEffect:@"Fall.wav"];
...
-(void) fadeOutMusic {
	[CDXPropertyModifierAction fadeBackgroundMusic:1.5f finalVolume:0.0f curveType:kIT_SCurve shouldStop:YES];
}	

-(void) fadeUpMusic {
	[CDXPropertyModifierAction fadeBackgroundMusic:0.5f finalVolume:1.0f curveType:kIT_SCurve shouldStop:NO];
}	
