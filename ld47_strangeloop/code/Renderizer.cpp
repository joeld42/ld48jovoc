...
#else
    PassSetup mainRenderPassSetup = PassSetup::From( this->mainRenderTarget, this->mainRenderTarget );
#endif
...
void Renderizer::renderScene(Tapnik::Scene* scene, Tapnik::UIAssets* uiAssets)
{
	...
	if (activeCamera) {
        ...
        backgroundFSparams.aTime = sceneTime * 0.1;
	}
