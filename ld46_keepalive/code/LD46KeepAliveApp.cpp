...
// These get crated in LD46KeepAlive-Main
extern Oryol::Args OryolArgs;

//------------------------------------------------------------------------------
AppState::Code
LD46KeepAliveApp::OnInit() {
	...
	const char* windowTitle = "LD Template (LD46KeepAlive)";
...
void
LD46KeepAliveApp::handleInputDebug() {
...
void LD46KeepAliveApp::nextCamera()
{
    activeCameraIndex++;
